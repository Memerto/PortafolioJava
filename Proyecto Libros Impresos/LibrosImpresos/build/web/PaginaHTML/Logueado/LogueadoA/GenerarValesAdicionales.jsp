...
<%-- 
    ...
    Created on : 09-04-2017, 3:51:22
    Author     : JoseMiguel
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="va" uri="http://java.sun.com/jsp/jstl/core"%>
...
<jsp:useBean id="val" scope="page" class="Modelo.Vale" />
<jsp:useBean id="vale" class="Controlador.TipoValeNegocio"/>
<jsp:setProperty name="val" property="*" />
<!DOCTYPE html>
<html >
<head>
    <meta charset="UTF-8">
...
<body>
   ...
   <br>
    ...
    <div id="registro">
        <form  name="frmRegistro" action="/../../LibrosImpresos/GenerarValeServlet" method="post">
            <select name="cmbTipoVale" class="cmbVale" style="cursor: pointer">
                <va:forEach items="${vale.consultarVale()}"  var="itema">
                    <option class="cmbVale"  style="cursor: pointer">${itema.getTipoVale()}</option>
                </va:forEach>
            </select> 
